...
*Implements the horizon essay's sight altitude: MUR/WOV carriage facts (was MALA) and Greencandy books projections on one Skate fold. Amphora, Dexter graduation, and Pond policy wait their own gates.*
...
Make the **seen books** vision checkable on the bench: extend `booksviewtest` with P&L and balance-sheet lines; add `sightviewtest` that folds carriage (MUR mint + WOV bundle; was MALA) and books (Greencandy journal) into one ten-line Skate frame.
