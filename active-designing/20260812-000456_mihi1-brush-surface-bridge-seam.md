# MIHI1 — the `.brush` surface-bridge seam
...
**Waymark:** **MIHI1** (surface bridge · durable core) — plan [`../expanding-prompts/20260811-220402_mihi-bit-design-system-and-greencandy-entities.md`](../expanding-prompts/20260811-220402_mihi-bit-design-system-and-greencandy-entities.md)
...
- **Horizon (named, not built):** Realidream as a full editor-browser face, and the DVUI-in-Swift-macOS-Dock shell (that is MIHI2, its own rung). This seam is the vocabulary those horizons will target; it does not build them.
