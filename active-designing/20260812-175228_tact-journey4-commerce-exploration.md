...
**Kin:** [`20260812-171050_the-1024-round-itinerary.md`](20260812-171050_the-1024-round-itinerary.md) · [`20260812-173656_tact-journey2-publishing-exploration.md`](20260812-173656_tact-journey2-publishing-exploration.md) · [`../greencandy/greencandy_core.rye`](../greencandy/greencandy_core.rye) · [`../seed/active-designing/20260811-220402_greencandy-entity-books-siya-and-linengrow.md`](../seed/active-designing/20260811-220402_greencandy-entity-books-siya-and-linengrow.md) · [`../work-in-progress/REMEMBER.md`](../work-in-progress/REMEMBER.md)
...
Greencandy already runs as Linengrow's centralized books of record — a chart of accounts, journal entries as append-only facts, a trial-balance fold whose conservation holds when the sum of debit-positive nets is zero, and reports as pure projections ([`../greencandy/greencandy_core.rye`](../greencandy/greencandy_core.rye)). The entity-books design extends that model to two entities and names the strand this journey needs: *a value crosses between parties only as an explicit fact recorded on both sides, never a silent shared balance* ([`../seed/active-designing/20260811-220402_greencandy-entity-books-siya-and-linengrow.md`](../seed/active-designing/20260811-220402_greencandy-entity-books-siya-and-linengrow.md)).
...
1. **Per book** — each side's entry is one debit and one credit of the same amount, so each book's trial balance nets to zero, exactly as Greencandy already requires.
