# CAUM2 — the recorder controls: samples land only while recording

**Stamp:** `20260814.021722` · **Language:** EN · **Voice:** Kyri · **Style:** Radiant
**Status:** Self-approved design round (Season A · waymark **CAUM** · Mikrophone firmware journey · rung CAUM2)
**Kin:** [`20260814-020500_caum-mikrophone-firmware-memory-that-forgets-exploration.md`](20260814-020500_caum-mikrophone-firmware-memory-that-forgets-exploration.md) · [`20260814-021218_caum1-wire-frame-carry-only-committed-exploration.md`](20260814-021218_caum1-wire-frame-carry-only-committed-exploration.md) · [`../mikrophone/session.rye`](../mikrophone/session.rye)

---

## Why this rung opens

CAUM0 proved the session that forgets; CAUM1 proved the wire frame that carries only what was committed. Both are the *substrate* — what a byte does once captured, and how a committed payload crosses. What neither yet names is the surface a keeper's thumb actually touches: the **record control**. A field recorder is not a raw buffer a keeper writes into byte by byte — it is a device with a record button, a pause, a stop. CAUM0's design read named this next: "the field-recorder controls" stand on a session already known correct.
