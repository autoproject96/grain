# CAUM4 — the inbox: the far side keeps a carried frame only once it is proven whole

**Stamp:** `20260814.022831` · **Language:** EN · **Voice:** Kyri · **Style:** Radiant
**Status:** Self-approved design round (Season A · waymark **CAUM** · Mikrophone firmware journey · rung CAUM4)
**Kin:** [`20260814-021218_caum1-wire-frame-carry-only-committed-exploration.md`](20260814-021218_caum1-wire-frame-carry-only-committed-exploration.md) · [`20260814-022312_caum3-firmware-loop-carry-committed-run-to-the-wire-exploration.md`](20260814-022312_caum3-firmware-loop-carry-committed-run-to-the-wire-exploration.md) · [`../mikrophone/wire.rye`](../mikrophone/wire.rye) · [`../mikrophone/firmware.rye`](../mikrophone/firmware.rye)

---

## Why this rung opens

CAUM3 proved the whole sending gesture: a keeper presses record, keeps on purpose, and only the kept capture crosses the single wire as a verify-before-trust frame. What no rung yet holds is the other end of that wire — the **far side that receives**. A carry has two hands: the device that frames and the desk that keeps. CAUM1 proved a frame can be deframed verify-before-trust; it did not prove what a receiver *does* with a good frame, nor — the sharper promise — that a receiver keeps *nothing* from a bad one. The SETU waymark already names this hearth carry, Glass to Desk; CAUM4 gives the Desk side its firmware discipline.
...
A new module `mikrophone/inbox.rye`, standing on CAUM1's `wire.deframe`, inventing no new transport:
...
*A carry is trustworthy only when both hands keep the same promise: the device sends only what was kept on purpose, and the desk keeps only what it has proven whole. CAUM4 writes that promise into the receiving hand.*
