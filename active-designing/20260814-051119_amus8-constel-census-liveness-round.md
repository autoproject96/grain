# AMUS8 — census: announce, collect, and know who is present
...
**Season:** the Six-Season double-seat, Season D/F thread · **Waymark:** AMUS · rung **AMUS8**
**Kin:** [`../constel/gossip.rye`](../constel/gossip.rye) · [`../constel/switchboard.rye`](../constel/switchboard.rye) · [`../constel/README.md`](../constel/README.md) · [`20260814-050539_amus7-constel-gossip-broadcast.md`](20260814-050539_amus7-constel-gossip-broadcast.md)

---

## The crux this round takes

AMUS7 gave the constellation a voice that reaches every ear at once. Yet an announce is only half a round — a real protocol needs the **other** half: **collect the replies and know who answered.** A heartbeat, a roll call, a quorum vote all share one shape: one pier announces, every other replies, and the caller **tallies who is present** and, just as important, **who is silent.** AMUS8 takes that one new concern — the *collect-and-tally* half of a gossip round — and nothing more.

This is the liveness primitive every consensus protocol stands on, and the natural companion to AMUS7's fan-out. It stays purely local — a bounded orchestration over the AMUS6 switchboard and AMUS7 broadcast on one bench, siloed to `constel/`, run from inside the jailed pier. No socket, no network, no keys, no funds, no real address ever formed. Custody gate #2 (real hardware / any real wire) and gate #4 (real Kumara, real network) both stay untouched.
