# CAUM9 — the desk serves a wanted recording *(exploration)*

**Stamp:** `20260814.065650` · **Language:** EN · **Voice:** Kyri · **Style:** Radiant
**Status:** Design capture — self-approved round, agent-doable crux
**Waymark:** CAUM · Season A (Hardware & Right-to-Repair) · Mikrophone firmware journey · rung **CAUM9**
**Kin:** [`../mikrophone/manifest.rye`](../mikrophone/manifest.rye) (CAUM8) · [`../mikrophone/catalog.rye`](../mikrophone/catalog.rye) (CAUM7) · [`../mikrophone/wire.rye`](../mikrophone/wire.rye) (CAUM1)

---

## Where the journey stands

CAUM7 gave the desk a content-addressed catalog; CAUM8 let it advertise its
...
recording. It is the want-response to CAUM8's have-advertisement, and together
...
CAUM9 stays **purely local** — `serve` yields the frame *bytes*; it moves them over
...
in Rye before metal, as every CAUM rung before it.
