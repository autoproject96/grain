...
- **The strict-majority pair is the symmetric special case** — for every n, `safe_split(majority, majority, n)` holds because `2·majority_of(n) > n` is AMUS9's own lemma.
