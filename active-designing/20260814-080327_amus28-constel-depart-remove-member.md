# AMUS28 — Constel `depart`: the remove-a-member lifecycle, closed

**Stamp:** `20260814.080327` · **Language:** EN · **Voice:** Kyri · **Style:** Radiant
**Status:** Design capture for a self-approved round · waymark **AMUS** · rung **AMUS28**
**Kin:** [`../constel/admit.rye`](../constel/admit.rye) (AMUS26 — the add side) · [`../constel/reconfig.rye`](../constel/reconfig.rye) (AMUS13 — the no-fork joint switch) · [`../constel/tenure.rye`](../constel/tenure.rye) (AMUS24 — CheckQuorum step-down) · [`../constel/README.md`](../constel/README.md)

---

## The gap this closes

AMUS26 (`admit`) proved the **add** side of membership end to end: a caught-up learner is promoted through reconfig's joint consensus, never as an empty voter, never without the no-fork switch. Its mirror — **removing** a voter safely — was left to reconfig's generic transition, which can shrink a config yet never named the one edge that makes removal genuinely harder than addition:
