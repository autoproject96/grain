...
The opening lap already ran under **VOLS** (survey) and did the first of **FUSS** (the living pins + the elder seat map swept to semantic / rested-history); the wider FUSS relabel, any OFFY cut, and the GRAD seal are CION's remaining rounds.
