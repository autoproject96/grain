...
Radiant pass `20260728.040237` — Gren Season g2 · living overwrite · seat 2 Gren · Sabin→Murr · gen_gren (not gen_djin)
...
Radiant pass `20260728.020607` — Ketu Aquarius 11 · Mala→Kamala Harris · Keaton/Sara/Sabin steward seats (rename-forward to Keeh)
...
2. **Gren seated** (was Djin · was Twah) — Taurus earth seat 2; vane `%gren` · domain prep **gren.fund** (claim his); edu gift for creating one of the twelve; **executive Grain Energy PBC President → Keaton lean** (`20260728.025634`). Sabin Hertz moved to **Murr**.  
...
| Executive | — | Sabin Hertz | **Keaton lean** (Grain Energy PBC President); Sabin → **Murr** |
