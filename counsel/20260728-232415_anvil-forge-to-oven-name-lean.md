...
**Prior:** Anvil retired tribute `20260727.131234` · living Lantern/Lattice/Anvil foundation · LEXICON Anvil module · Haunted Mound Magazine Arc V  
...
**Like Oven best** for the living forge seat. Short · warm · commons · bread. The triad reads clean: **Lantern · Lattice · Oven**. Weapons and armor leave the name; the Haunted Mound tribute to DJ Anvil stays honored in gratitude and Magazine Arc V — the living work stops borrowing the blade.
...
Separate from dated-writing Class H mutants. MUR-shaped: **content breach** then **filename/path breach** on his word · gratitude pin for Haunted Mound affirmed · living mutant of `lantern-lattice-anvil` → new stamp with new title · Class H the old path · `anvil/` module rename is the heavy door (parity · Skate views · Q-vane faculty) — size before cutting.
