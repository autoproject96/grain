...
Radiant pass `20260728.050004` — u10 living doors · SPEC · Greencandy · mala-wov · ER → MUR · code held  
...
INNERMOST SCOPE (this season — walk here):
  ...
  Fund seat 1: Murr (was Mala) · Aries · %murr · murr.fund prep · honor Kyler Murray · executive Sabin Hertz.
...
run gen_murr (GREEN; deploy RED) · report · then walk u69 from the charter:
  ...
  affirm Kyler · Sabin · WOV-last · affirm rename-overwrite + filename-rename breaches approved ·
