...
CORE SCOPE (this season — walk here):
  ...
  Murr: dedication Kyler Murray KEPT · executive Sabin Hertz (moved from Djin).
  ...
  Lexicon: scope·outer·inner·innermost·core·quint · Gren · Djin retired · Murr+Sabin · sundial.
  Prin: rishi/bin/rishi run tools/prin.rish scope
  gen_gren GREEN · deploy RED; gen_murr GREEN with Sabin executive; gen_keeh still GREEN.
...
run gen_gren (GREEN; deploy RED) · run gen_murr (GREEN; Sabin+Kyler) · report ·
then walk g13 from the charter:
  affirm three pauses above + quint CLOSED · affirm Djin→Gren · Sabin→Murr · Keaton→Gren ·
  second harden: gen trio GREEN · Sabin on Murr · deploy RED · Choir lean held · then horizon g14 ·
...
words seated (blank = held whole): season_name= choir= LICENSE_WORD=
  ...
  murr_dedication=Kyler_Murray murr_executive=Sabin_Hertz
