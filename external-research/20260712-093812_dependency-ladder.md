...
- **D1 · Mesh inference (TAME-guided)** — pooled compute admitted by Kumara pass, metered by MUR (was MALA), priced by Mandi, booked by Greencandy. **Blockers: C1 (Comlink), C3 (Mycelium/M4), the seL4 seat, and a model-runtime gratitude seam not yet begun.** Simmer.
