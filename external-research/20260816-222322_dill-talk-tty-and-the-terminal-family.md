...
- **Dimeroll over Greencandy** stays seated: `dimeroll.com` is the born name, Greencandy the fossil (147 living references await a cairn-first molt/debride, Season B). Remembered in the operator card's breach queue.
