...
| Stamp | Note | Meaning |
|-------|------|---------|
| `20260814.071700` | [Hardware & Right-to-Repair](20260814-071700_hardware-and-right-to-repair.md) | the Season A front door — the body you can hold: the Mikrophone that forgets on purpose (CAUM, thirteen rungs), the open image module with the Photos app and parts marketplace above it (HUNK), four surfaces proven pure in Rye before the metal, real hardware held as custody gate #2/#3 |
