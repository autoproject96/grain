...
**Status:** Seated — name + listing (`165634`); floor view (`170700`); listing settle (`171202`); settle view (`172955`); **steward demo** list→settle→Greencandy (`004652`, nib **419**); live TigerBeetle rests until its brief
