...
| Other modules' witnesses in [`../tools/`](../tools/) | Run `tools/kumara_tilak_witness.rish`, `tools/pond_ring_greencandy_witness.rish`, and their neighbors — each proves a different module green, the same way scribe just did |
