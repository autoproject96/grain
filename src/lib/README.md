...
| `gate-caravan-children-bound-u32` | children = 4 | 2→1 · 5→0 |
...
| `gate-caravan-caps-bound-u32` | caps/child = 8 | 4→1 · 9→0 |
...
| Desk | Role | Witness |
| --- | --- | --- |
| [`shape-caravan-max-children.glow`](shape-caravan-max-children.glow) | Names `max_children=4` beside `caravan/capabilities.rye` | `tools/caravan_glow_tend_limb1_witness.rish` |
| [`shape-caravan-max-caps-per-child.glow`](shape-caravan-max-caps-per-child.glow) | Names `max_caps_per_child=8` beside `caravan/capabilities.rye` | `tools/caravan_glow_tend_limb2_witness.rish` |
