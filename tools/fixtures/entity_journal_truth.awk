# tools/fixtures/entity_journal_truth.awk — an independent measurement of a Greencandy journal fixture.
#
...
#
#   awk -f tools/fixtures/entity_journal_truth.awk greencandy/fixtures/journal.bron
