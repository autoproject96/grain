#!/bin/sh
# gen_bozo_fund_prep.sh — Bozo fund prep (Capricorn earth · seat 10 · was Linn · Helen · Sabin)
set -eu
...
grep -q 'Sabin Hertz' context/LEXICON.md
...
grep -q 'Sabin Hertz' "$PAGE"
grep -q 'no live deploy' "$PAGE"
grep -q 'witness:bozo-open GREEN' "$PAGE"
test -f counsel/date/20260730/20260730-150702_pole-bozo-sabin-murr-keaton.md
...
echo "executive: Sabin Hertz (from Murr · POLE)"
echo "hats: sponsor held (blank)"
echo "page: edu/funds/bozo-opening.md (prep grow · page one)"
echo "witness:bozo-open GREEN — seat · Helen dedication · Sabin executive · vane · hard lines"
echo "refuse: deploy · wallet · gas · claim-domain · shred · breach"
echo "bozo_fund=prep"
echo "GREEN: gen-bozo — Capricorn earth seat 10 · Helen · Sabin · deploy RED"
